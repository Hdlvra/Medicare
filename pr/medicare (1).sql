...
INSERT INTO `laboratoire` (`id`, `nom`, `email`, `telephone`, `salle`, `photo`, `adresse`) VALUES
(1, 'Laboratoire Pasteur', 'contact@pasteurlab.fr', '0145234567', 'Salle 201', 'labo/labo1.jpg', '123'),
(2, 'Laboratoire BioSanté', 'infos@biosante.fr', '0176543210', 'Salle 105', 'labo/labo1.jpg', '423'),
(3, 'Laboratoire MedTech', 'rdv@medtech.fr', '0167894523', 'Salle 310', 'labo/labo1.jpg', '344');
...
CREATE TABLE IF NOT EXISTS `disponibilites_labo` (
  ...
  `heure_fin` TIME NOT NULL,
  PRIMARY KEY (`id`),
  FOREIGN KEY (`id_laboratoire`) REFERENCES `laboratoire`(`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;


INSERT INTO `disponibilites_labo` (`id`, `id_laboratoire`, `heure_debut`, `heure_fin`) VALUES
(1, '1', '09:00:00', '18:00:00'),
(2, '2', '07:00:00', '16:00:00'),
(3, '3', '08:30:00', '17:30:00');
...
CREATE TABLE IF NOT EXISTS `rdv_labo` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `id_client` INT NOT NULL,
  `id_laboratoire` INT NOT NULL,
  `date` DATE NOT NULL,
